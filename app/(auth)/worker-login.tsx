...
export default function WorkerLoginScreen() {
  const { loginWorker, error } = useAuth();
  ...
  const handleLogin = async () => {
    ...
    setLoading(true);
    const result = await loginWorker({ phone, pin }, { method: "PIN" });
    setLoading(false);
  ...
  return (
    <AuthScreenLayout>
      ...
      <Text style={styles.subtitle}>
        Enter your mobile number and worker PIN. Owner approval login will be
